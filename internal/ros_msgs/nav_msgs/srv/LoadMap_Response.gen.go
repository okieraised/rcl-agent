...
func init() {
	humble.RegisterMessage("nav_msgs/LoadMap_Response", LoadMap_ResponseTypeSupport)
	humble.RegisterMessage("nav_msgs/srv/LoadMap_Response", LoadMap_ResponseTypeSupport)
}
...
func (t *LoadMap_Response) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *LoadMap_Response) GetTypeSupport() humble.MessageTypeSupport {
	return LoadMap_ResponseTypeSupport
}

// LoadMap_ResponsePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// LoadMap_Response
func NewLoadMap_ResponsePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*LoadMap_ResponsePublisher, error) {
...
// LoadMap_ResponseSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type LoadMap_ResponseSubscriptionCallback func(msg *LoadMap_Response, info *humble.MessageInfo, err error)

// NewLoadMap_ResponseSubscription creates and returns a new subscription for the
// LoadMap_Response
func NewLoadMap_ResponseSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback LoadMap_ResponseSubscriptionCallback) (*LoadMap_ResponseSubscription, error) {
...
func (s *LoadMap_ResponseSubscription) TakeMessage(out *LoadMap_Response) (*humble.MessageInfo, error) {
...
var LoadMap_ResponseTypeSupport humble.MessageTypeSupport = _LoadMap_ResponseTypeSupport{}

type _LoadMap_ResponseTypeSupport struct{}

func (t _LoadMap_ResponseTypeSupport) New() humble.Message {
...
func (t _LoadMap_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _LoadMap_ResponseTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*LoadMap_Response)
