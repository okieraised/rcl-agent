...
func init() {
	humble.RegisterMessage("nav_msgs/GetPlan_Request", GetPlan_RequestTypeSupport)
	humble.RegisterMessage("nav_msgs/srv/GetPlan_Request", GetPlan_RequestTypeSupport)
}
...
func (t *GetPlan_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *GetPlan_Request) GetTypeSupport() humble.MessageTypeSupport {
	return GetPlan_RequestTypeSupport
}

// GetPlan_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// GetPlan_Request
func NewGetPlan_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*GetPlan_RequestPublisher, error) {
...
// GetPlan_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type GetPlan_RequestSubscriptionCallback func(msg *GetPlan_Request, info *humble.MessageInfo, err error)

// NewGetPlan_RequestSubscription creates and returns a new subscription for the
// GetPlan_Request
func NewGetPlan_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback GetPlan_RequestSubscriptionCallback) (*GetPlan_RequestSubscription, error) {
...
func (s *GetPlan_RequestSubscription) TakeMessage(out *GetPlan_Request) (*humble.MessageInfo, error) {
...
var GetPlan_RequestTypeSupport humble.MessageTypeSupport = _GetPlan_RequestTypeSupport{}

type _GetPlan_RequestTypeSupport struct{}

func (t _GetPlan_RequestTypeSupport) New() humble.Message {
...
func (t _GetPlan_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _GetPlan_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*GetPlan_Request)
