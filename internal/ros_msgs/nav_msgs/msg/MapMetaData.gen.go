...
func init() {
	humble.RegisterMessage("nav_msgs/MapMetaData", MapMetaDataTypeSupport)
	humble.RegisterMessage("nav_msgs/msg/MapMetaData", MapMetaDataTypeSupport)
}
...
func (t *MapMetaData) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *MapMetaData) GetTypeSupport() humble.MessageTypeSupport {
	return MapMetaDataTypeSupport
}

// MapMetaDataPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// MapMetaData
func NewMapMetaDataPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*MapMetaDataPublisher, error) {
...
// MapMetaDataSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type MapMetaDataSubscriptionCallback func(msg *MapMetaData, info *humble.MessageInfo, err error)

// NewMapMetaDataSubscription creates and returns a new subscription for the
// MapMetaData
func NewMapMetaDataSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback MapMetaDataSubscriptionCallback) (*MapMetaDataSubscription, error) {
...
func (s *MapMetaDataSubscription) TakeMessage(out *MapMetaData) (*humble.MessageInfo, error) {
...
var MapMetaDataTypeSupport humble.MessageTypeSupport = _MapMetaDataTypeSupport{}

type _MapMetaDataTypeSupport struct{}

func (t _MapMetaDataTypeSupport) New() humble.Message {
...
func (t _MapMetaDataTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*MapMetaData)
...
func (t _MapMetaDataTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*MapMetaData)
