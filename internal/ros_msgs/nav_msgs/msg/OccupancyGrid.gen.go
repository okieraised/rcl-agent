...
func init() {
	humble.RegisterMessage("nav_msgs/OccupancyGrid", OccupancyGridTypeSupport)
	humble.RegisterMessage("nav_msgs/msg/OccupancyGrid", OccupancyGridTypeSupport)
}
...
func (t *OccupancyGrid) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *OccupancyGrid) GetTypeSupport() humble.MessageTypeSupport {
	return OccupancyGridTypeSupport
}

// OccupancyGridPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// OccupancyGrid
func NewOccupancyGridPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*OccupancyGridPublisher, error) {
...
// OccupancyGridSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type OccupancyGridSubscriptionCallback func(msg *OccupancyGrid, info *humble.MessageInfo, err error)

// NewOccupancyGridSubscription creates and returns a new subscription for the
// OccupancyGrid
func NewOccupancyGridSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback OccupancyGridSubscriptionCallback) (*OccupancyGridSubscription, error) {
...
func (s *OccupancyGridSubscription) TakeMessage(out *OccupancyGrid) (*humble.MessageInfo, error) {
...
var OccupancyGridTypeSupport humble.MessageTypeSupport = _OccupancyGridTypeSupport{}

type _OccupancyGridTypeSupport struct{}

func (t _OccupancyGridTypeSupport) New() humble.Message {
...
func (t _OccupancyGridTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*OccupancyGrid)
...
func (t _OccupancyGridTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*OccupancyGrid)
