...
func init() {
	humble.RegisterMessage("visualization_msgs/GetInteractiveMarkers_Response", GetInteractiveMarkers_ResponseTypeSupport)
	humble.RegisterMessage("visualization_msgs/srv/GetInteractiveMarkers_Response", GetInteractiveMarkers_ResponseTypeSupport)
}
...
func (t *GetInteractiveMarkers_Response) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *GetInteractiveMarkers_Response) GetTypeSupport() humble.MessageTypeSupport {
	return GetInteractiveMarkers_ResponseTypeSupport
}

// GetInteractiveMarkers_ResponsePublisher wraps humble.Publisher to provide type safe helper
// functions
...
func NewGetInteractiveMarkers_ResponsePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*GetInteractiveMarkers_ResponsePublisher, error) {
...
// GetInteractiveMarkers_ResponseSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type GetInteractiveMarkers_ResponseSubscriptionCallback func(msg *GetInteractiveMarkers_Response, info *humble.MessageInfo, err error)

// NewGetInteractiveMarkers_ResponseSubscription creates and returns a new subscription for the
// GetInteractiveMarkers_Response
func NewGetInteractiveMarkers_ResponseSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback GetInteractiveMarkers_ResponseSubscriptionCallback) (*GetInteractiveMarkers_ResponseSubscription, error) {
...
func (s *GetInteractiveMarkers_ResponseSubscription) TakeMessage(out *GetInteractiveMarkers_Response) (*humble.MessageInfo, error) {
...
var GetInteractiveMarkers_ResponseTypeSupport humble.MessageTypeSupport = _GetInteractiveMarkers_ResponseTypeSupport{}

type _GetInteractiveMarkers_ResponseTypeSupport struct{}

func (t _GetInteractiveMarkers_ResponseTypeSupport) New() humble.Message {
...
func (t _GetInteractiveMarkers_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _GetInteractiveMarkers_ResponseTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*GetInteractiveMarkers_Response)
