...
func init() {
	humble.RegisterMessage("visualization_msgs/InteractiveMarkerInit", InteractiveMarkerInitTypeSupport)
	humble.RegisterMessage("visualization_msgs/msg/InteractiveMarkerInit", InteractiveMarkerInitTypeSupport)
}
...
func (t *InteractiveMarkerInit) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *InteractiveMarkerInit) GetTypeSupport() humble.MessageTypeSupport {
	return InteractiveMarkerInitTypeSupport
}

// InteractiveMarkerInitPublisher wraps humble.Publisher to provide type safe helper
// functions
...
func NewInteractiveMarkerInitPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*InteractiveMarkerInitPublisher, error) {
...
// InteractiveMarkerInitSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type InteractiveMarkerInitSubscriptionCallback func(msg *InteractiveMarkerInit, info *humble.MessageInfo, err error)

// NewInteractiveMarkerInitSubscription creates and returns a new subscription for the
// InteractiveMarkerInit
func NewInteractiveMarkerInitSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback InteractiveMarkerInitSubscriptionCallback) (*InteractiveMarkerInitSubscription, error) {
...
func (s *InteractiveMarkerInitSubscription) TakeMessage(out *InteractiveMarkerInit) (*humble.MessageInfo, error) {
...
var InteractiveMarkerInitTypeSupport humble.MessageTypeSupport = _InteractiveMarkerInitTypeSupport{}

type _InteractiveMarkerInitTypeSupport struct{}

func (t _InteractiveMarkerInitTypeSupport) New() humble.Message {
...
func (t _InteractiveMarkerInitTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _InteractiveMarkerInitTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*InteractiveMarkerInit)
