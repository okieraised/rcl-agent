...
func init() {
	humble.RegisterMessage("visualization_msgs/ImageMarker", ImageMarkerTypeSupport)
	humble.RegisterMessage("visualization_msgs/msg/ImageMarker", ImageMarkerTypeSupport)
}
...
func (t *ImageMarker) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *ImageMarker) GetTypeSupport() humble.MessageTypeSupport {
	return ImageMarkerTypeSupport
}

// ImageMarkerPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// ImageMarker
func NewImageMarkerPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*ImageMarkerPublisher, error) {
...
// ImageMarkerSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type ImageMarkerSubscriptionCallback func(msg *ImageMarker, info *humble.MessageInfo, err error)

// NewImageMarkerSubscription creates and returns a new subscription for the
// ImageMarker
func NewImageMarkerSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback ImageMarkerSubscriptionCallback) (*ImageMarkerSubscription, error) {
...
func (s *ImageMarkerSubscription) TakeMessage(out *ImageMarker) (*humble.MessageInfo, error) {
...
var ImageMarkerTypeSupport humble.MessageTypeSupport = _ImageMarkerTypeSupport{}

type _ImageMarkerTypeSupport struct{}

func (t _ImageMarkerTypeSupport) New() humble.Message {
...
func (t _ImageMarkerTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*ImageMarker)
...
func (t _ImageMarkerTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*ImageMarker)
