...
func init() {
	humble.RegisterMessage("visualization_msgs/UVCoordinate", UVCoordinateTypeSupport)
	humble.RegisterMessage("visualization_msgs/msg/UVCoordinate", UVCoordinateTypeSupport)
}
...
func (t *UVCoordinate) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *UVCoordinate) GetTypeSupport() humble.MessageTypeSupport {
	return UVCoordinateTypeSupport
}

// UVCoordinatePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// UVCoordinate
func NewUVCoordinatePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*UVCoordinatePublisher, error) {
...
// UVCoordinateSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type UVCoordinateSubscriptionCallback func(msg *UVCoordinate, info *humble.MessageInfo, err error)

// NewUVCoordinateSubscription creates and returns a new subscription for the
// UVCoordinate
func NewUVCoordinateSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback UVCoordinateSubscriptionCallback) (*UVCoordinateSubscription, error) {
...
func (s *UVCoordinateSubscription) TakeMessage(out *UVCoordinate) (*humble.MessageInfo, error) {
...
var UVCoordinateTypeSupport humble.MessageTypeSupport = _UVCoordinateTypeSupport{}

type _UVCoordinateTypeSupport struct{}

func (t _UVCoordinateTypeSupport) New() humble.Message {
...
func (t _UVCoordinateTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*UVCoordinate)
...
func (t _UVCoordinateTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*UVCoordinate)
