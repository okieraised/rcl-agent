...
func init() {
	humble.RegisterMessage("unitree_go/MotorCmd", MotorCmdTypeSupport)
	humble.RegisterMessage("unitree_go/msg/MotorCmd", MotorCmdTypeSupport)
}
...
type CMotorCmdSequence = C.unitree_go__msg__MotorCmd__Sequence
