...
func init() {
	humble.RegisterMessage("rcl_interfaces/SetParametersAtomically_Request", SetParametersAtomically_RequestTypeSupport)
	humble.RegisterMessage("rcl_interfaces/srv/SetParametersAtomically_Request", SetParametersAtomically_RequestTypeSupport)
}
...
func (t *SetParametersAtomically_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *SetParametersAtomically_Request) GetTypeSupport() humble.MessageTypeSupport {
	return SetParametersAtomically_RequestTypeSupport
}

// SetParametersAtomically_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
func NewSetParametersAtomically_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*SetParametersAtomically_RequestPublisher, error) {
...
// SetParametersAtomically_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type SetParametersAtomically_RequestSubscriptionCallback func(msg *SetParametersAtomically_Request, info *humble.MessageInfo, err error)

// NewSetParametersAtomically_RequestSubscription creates and returns a new subscription for the
// SetParametersAtomically_Request
func NewSetParametersAtomically_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback SetParametersAtomically_RequestSubscriptionCallback) (*SetParametersAtomically_RequestSubscription, error) {
...
func (s *SetParametersAtomically_RequestSubscription) TakeMessage(out *SetParametersAtomically_Request) (*humble.MessageInfo, error) {
...
var SetParametersAtomically_RequestTypeSupport humble.MessageTypeSupport = _SetParametersAtomically_RequestTypeSupport{}

type _SetParametersAtomically_RequestTypeSupport struct{}

func (t _SetParametersAtomically_RequestTypeSupport) New() humble.Message {
...
func (t _SetParametersAtomically_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _SetParametersAtomically_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*SetParametersAtomically_Request)
