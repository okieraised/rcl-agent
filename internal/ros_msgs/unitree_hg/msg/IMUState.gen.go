...
func init() {
	humble.RegisterMessage("unitree_hg/IMUState", IMUStateTypeSupport)
	humble.RegisterMessage("unitree_hg/msg/IMUState", IMUStateTypeSupport)
}
...
func (t _IMUStateTypeSupport) PrepareMemory() unsafe.Pointer { //returns *C.unitree_hg__msg__IMUState
	return (unsafe.Pointer)(C.unitree_hg__msg__IMUState__create())
}

func (t _IMUStateTypeSupport) ReleaseMemory(pointer_to_free unsafe.Pointer) {
	C.unitree_hg__msg__IMUState__destroy((*C.unitree_hg__msg__IMUState)(pointer_to_free))
}

func (t _IMUStateTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*IMUState)
	mem := (*C.unitree_hg__msg__IMUState)(dst)
...
func (t _IMUStateTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*IMUState)
	mem := (*C.unitree_hg__msg__IMUState)(ros2_message_buffer)
	cSlice_quaternion := mem.quaternion[:]
...
func (t _IMUStateTypeSupport) TypeSupport() unsafe.Pointer {
	return unsafe.Pointer(C.rosidl_typesupport_c__get_message_type_support_handle__unitree_hg__msg__IMUState())
}

type CIMUState = C.unitree_hg__msg__IMUState
type CIMUStateSequence = C.unitree_hg__msg__IMUState__Sequence
...
func IMUStateSequenceToC(cSlice *CIMUStateSequence, goSlice []IMUState) {
	...
	cSlice.data = (*C.unitree_hg__msg__IMUState)(C.malloc(C.sizeof_struct_unitree_hg__msg__IMUState * C.size_t(len(goSlice))))
