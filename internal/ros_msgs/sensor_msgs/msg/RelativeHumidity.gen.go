...
func init() {
	humble.RegisterMessage("sensor_msgs/RelativeHumidity", RelativeHumidityTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/RelativeHumidity", RelativeHumidityTypeSupport)
}
...
func (t *RelativeHumidity) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *RelativeHumidity) GetTypeSupport() humble.MessageTypeSupport {
	return RelativeHumidityTypeSupport
}

// RelativeHumidityPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// RelativeHumidity
func NewRelativeHumidityPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*RelativeHumidityPublisher, error) {
...
// RelativeHumiditySubscription wraps humble.Subscription to provide type safe helper
// functions
...
type RelativeHumiditySubscriptionCallback func(msg *RelativeHumidity, info *humble.MessageInfo, err error)

// NewRelativeHumiditySubscription creates and returns a new subscription for the
// RelativeHumidity
func NewRelativeHumiditySubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback RelativeHumiditySubscriptionCallback) (*RelativeHumiditySubscription, error) {
...
func (s *RelativeHumiditySubscription) TakeMessage(out *RelativeHumidity) (*humble.MessageInfo, error) {
...
var RelativeHumidityTypeSupport humble.MessageTypeSupport = _RelativeHumidityTypeSupport{}

type _RelativeHumidityTypeSupport struct{}

func (t _RelativeHumidityTypeSupport) New() humble.Message {
...
func (t _RelativeHumidityTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _RelativeHumidityTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*RelativeHumidity)
