...
func init() {
	humble.RegisterMessage("sensor_msgs/TimeReference", TimeReferenceTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/TimeReference", TimeReferenceTypeSupport)
}
...
func (t *TimeReference) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *TimeReference) GetTypeSupport() humble.MessageTypeSupport {
	return TimeReferenceTypeSupport
}

// TimeReferencePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// TimeReference
func NewTimeReferencePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*TimeReferencePublisher, error) {
...
// TimeReferenceSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type TimeReferenceSubscriptionCallback func(msg *TimeReference, info *humble.MessageInfo, err error)

// NewTimeReferenceSubscription creates and returns a new subscription for the
// TimeReference
func NewTimeReferenceSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback TimeReferenceSubscriptionCallback) (*TimeReferenceSubscription, error) {
...
func (s *TimeReferenceSubscription) TakeMessage(out *TimeReference) (*humble.MessageInfo, error) {
...
var TimeReferenceTypeSupport humble.MessageTypeSupport = _TimeReferenceTypeSupport{}

type _TimeReferenceTypeSupport struct{}

func (t _TimeReferenceTypeSupport) New() humble.Message {
...
func (t _TimeReferenceTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*TimeReference)
...
func (t _TimeReferenceTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*TimeReference)
