...
func init() {
	humble.RegisterMessage("sensor_msgs/Temperature", TemperatureTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/Temperature", TemperatureTypeSupport)
}
...
func (t *Temperature) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Temperature) GetTypeSupport() humble.MessageTypeSupport {
	return TemperatureTypeSupport
}

// TemperaturePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// Temperature
func NewTemperaturePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*TemperaturePublisher, error) {
...
// TemperatureSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type TemperatureSubscriptionCallback func(msg *Temperature, info *humble.MessageInfo, err error)

// NewTemperatureSubscription creates and returns a new subscription for the
// Temperature
func NewTemperatureSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback TemperatureSubscriptionCallback) (*TemperatureSubscription, error) {
...
func (s *TemperatureSubscription) TakeMessage(out *Temperature) (*humble.MessageInfo, error) {
...
var TemperatureTypeSupport humble.MessageTypeSupport = _TemperatureTypeSupport{}

type _TemperatureTypeSupport struct{}

func (t _TemperatureTypeSupport) New() humble.Message {
...
func (t _TemperatureTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*Temperature)
...
func (t _TemperatureTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Temperature)
