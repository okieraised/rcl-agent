...
func init() {
	humble.RegisterMessage("sensor_msgs/BatteryState", BatteryStateTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/BatteryState", BatteryStateTypeSupport)
}
...
func (t *BatteryState) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *BatteryState) GetTypeSupport() humble.MessageTypeSupport {
	return BatteryStateTypeSupport
}

// BatteryStatePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// BatteryState
func NewBatteryStatePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*BatteryStatePublisher, error) {
...
// BatteryStateSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type BatteryStateSubscriptionCallback func(msg *BatteryState, info *humble.MessageInfo, err error)

// NewBatteryStateSubscription creates and returns a new subscription for the
// BatteryState
func NewBatteryStateSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback BatteryStateSubscriptionCallback) (*BatteryStateSubscription, error) {
...
func (s *BatteryStateSubscription) TakeMessage(out *BatteryState) (*humble.MessageInfo, error) {
...
var BatteryStateTypeSupport humble.MessageTypeSupport = _BatteryStateTypeSupport{}

type _BatteryStateTypeSupport struct{}

func (t _BatteryStateTypeSupport) New() humble.Message {
...
func (t _BatteryStateTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*BatteryState)
	...
	humble.Float32SequenceToC((*humble.CFloat32Sequence)(unsafe.Pointer(&mem.cell_voltage)), m.CellVoltage)
	humble.Float32SequenceToC((*humble.CFloat32Sequence)(unsafe.Pointer(&mem.cell_temperature)), m.CellTemperature)
	humble.StringAsCStruct(unsafe.Pointer(&mem.location), m.Location)
	humble.StringAsCStruct(unsafe.Pointer(&mem.serial_number), m.SerialNumber)
}

func (t _BatteryStateTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*BatteryState)
	...
	humble.Float32SequenceToGo(&m.CellVoltage, *(*humble.CFloat32Sequence)(unsafe.Pointer(&mem.cell_voltage)))
	humble.Float32SequenceToGo(&m.CellTemperature, *(*humble.CFloat32Sequence)(unsafe.Pointer(&mem.cell_temperature)))
	humble.StringAsGoStruct(&m.Location, unsafe.Pointer(&mem.location))
