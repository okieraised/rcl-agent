...
func init() {
	humble.RegisterMessage("sensor_msgs/PointField", PointFieldTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/PointField", PointFieldTypeSupport)
}
...
func (t *PointField) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *PointField) GetTypeSupport() humble.MessageTypeSupport {
	return PointFieldTypeSupport
}

// PointFieldPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// PointField
func NewPointFieldPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*PointFieldPublisher, error) {
...
// PointFieldSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type PointFieldSubscriptionCallback func(msg *PointField, info *humble.MessageInfo, err error)

// NewPointFieldSubscription creates and returns a new subscription for the
// PointField
func NewPointFieldSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback PointFieldSubscriptionCallback) (*PointFieldSubscription, error) {
...
func (s *PointFieldSubscription) TakeMessage(out *PointField) (*humble.MessageInfo, error) {
...
var PointFieldTypeSupport humble.MessageTypeSupport = _PointFieldTypeSupport{}

type _PointFieldTypeSupport struct{}

func (t _PointFieldTypeSupport) New() humble.Message {
...
func (t _PointFieldTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*PointField)
...
func (t _PointFieldTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*PointField)
