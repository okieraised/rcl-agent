...
func init() {
	humble.RegisterMessage("sensor_msgs/RegionOfInterest", RegionOfInterestTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/RegionOfInterest", RegionOfInterestTypeSupport)
}
...
func (t *RegionOfInterest) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *RegionOfInterest) GetTypeSupport() humble.MessageTypeSupport {
	return RegionOfInterestTypeSupport
}

// RegionOfInterestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// RegionOfInterest
func NewRegionOfInterestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*RegionOfInterestPublisher, error) {
...
// RegionOfInterestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type RegionOfInterestSubscriptionCallback func(msg *RegionOfInterest, info *humble.MessageInfo, err error)

// NewRegionOfInterestSubscription creates and returns a new subscription for the
// RegionOfInterest
func NewRegionOfInterestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback RegionOfInterestSubscriptionCallback) (*RegionOfInterestSubscription, error) {
...
func (s *RegionOfInterestSubscription) TakeMessage(out *RegionOfInterest) (*humble.MessageInfo, error) {
...
var RegionOfInterestTypeSupport humble.MessageTypeSupport = _RegionOfInterestTypeSupport{}

type _RegionOfInterestTypeSupport struct{}

func (t _RegionOfInterestTypeSupport) New() humble.Message {
...
func (t _RegionOfInterestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _RegionOfInterestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*RegionOfInterest)
