...
func init() {
	humble.RegisterMessage("sensor_msgs/CameraInfo", CameraInfoTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/CameraInfo", CameraInfoTypeSupport)
}
...
func (t *CameraInfo) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *CameraInfo) GetTypeSupport() humble.MessageTypeSupport {
	return CameraInfoTypeSupport
}

// CameraInfoPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// CameraInfo
func NewCameraInfoPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*CameraInfoPublisher, error) {
...
// CameraInfoSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type CameraInfoSubscriptionCallback func(msg *CameraInfo, info *humble.MessageInfo, err error)

// NewCameraInfoSubscription creates and returns a new subscription for the
// CameraInfo
func NewCameraInfoSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback CameraInfoSubscriptionCallback) (*CameraInfoSubscription, error) {
...
func (s *CameraInfoSubscription) TakeMessage(out *CameraInfo) (*humble.MessageInfo, error) {
...
var CameraInfoTypeSupport humble.MessageTypeSupport = _CameraInfoTypeSupport{}

type _CameraInfoTypeSupport struct{}

func (t _CameraInfoTypeSupport) New() humble.Message {
...
func (t _CameraInfoTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*CameraInfo)
	mem := (*C.sensor_msgs__msg__CameraInfo)(dst)
	std_msgs_msg.HeaderTypeSupport.AsCStruct(unsafe.Pointer(&mem.header), &m.Header)
	mem.height = C.uint32_t(m.Height)
	mem.width = C.uint32_t(m.Width)
	humble.StringAsCStruct(unsafe.Pointer(&mem.distortion_model), m.DistortionModel)
	humble.Float64SequenceToC((*humble.CFloat64Sequence)(unsafe.Pointer(&mem.d)), m.D)
	cSlice_k := mem.k[:]
	humble.Float64ArrayToC(*(*[]humble.CFloat64)(unsafe.Pointer(&cSlice_k)), m.K[:])
	cSlice_r := mem.r[:]
	humble.Float64ArrayToC(*(*[]humble.CFloat64)(unsafe.Pointer(&cSlice_r)), m.R[:])
	cSlice_p := mem.p[:]
	humble.Float64ArrayToC(*(*[]humble.CFloat64)(unsafe.Pointer(&cSlice_p)), m.P[:])
...
func (t _CameraInfoTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*CameraInfo)
	mem := (*C.sensor_msgs__msg__CameraInfo)(ros2_message_buffer)
	std_msgs_msg.HeaderTypeSupport.AsGoStruct(&m.Header, unsafe.Pointer(&mem.header))
	m.Height = uint32(mem.height)
	m.Width = uint32(mem.width)
	humble.StringAsGoStruct(&m.DistortionModel, unsafe.Pointer(&mem.distortion_model))
	humble.Float64SequenceToGo(&m.D, *(*humble.CFloat64Sequence)(unsafe.Pointer(&mem.d)))
	cSlice_k := mem.k[:]
	humble.Float64ArrayToGo(m.K[:], *(*[]humble.CFloat64)(unsafe.Pointer(&cSlice_k)))
	cSlice_r := mem.r[:]
	humble.Float64ArrayToGo(m.R[:], *(*[]humble.CFloat64)(unsafe.Pointer(&cSlice_r)))
	cSlice_p := mem.p[:]
	humble.Float64ArrayToGo(m.P[:], *(*[]humble.CFloat64)(unsafe.Pointer(&cSlice_p)))
