...
func init() {
	humble.RegisterMessage("sensor_msgs/PointCloud2", PointCloud2TypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/PointCloud2", PointCloud2TypeSupport)
}
...
func (t *PointCloud2) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *PointCloud2) GetTypeSupport() humble.MessageTypeSupport {
	return PointCloud2TypeSupport
}

// PointCloud2Publisher wraps humble.Publisher to provide type safe helper
// functions
...
// PointCloud2
func NewPointCloud2Publisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*PointCloud2Publisher, error) {
...
// PointCloud2Subscription wraps humble.Subscription to provide type safe helper
// functions
...
type PointCloud2SubscriptionCallback func(msg *PointCloud2, info *humble.MessageInfo, err error)

// NewPointCloud2Subscription creates and returns a new subscription for the
// PointCloud2
func NewPointCloud2Subscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback PointCloud2SubscriptionCallback) (*PointCloud2Subscription, error) {
...
func (s *PointCloud2Subscription) TakeMessage(out *PointCloud2) (*humble.MessageInfo, error) {
...
var PointCloud2TypeSupport humble.MessageTypeSupport = _PointCloud2TypeSupport{}

type _PointCloud2TypeSupport struct{}

func (t _PointCloud2TypeSupport) New() humble.Message {
...
func (t _PointCloud2TypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*PointCloud2)
...
func (t _PointCloud2TypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*PointCloud2)
