...
func init() {
	humble.RegisterMessage("sensor_msgs/JoyFeedbackArray", JoyFeedbackArrayTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/JoyFeedbackArray", JoyFeedbackArrayTypeSupport)
}
...
func (t *JoyFeedbackArray) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *JoyFeedbackArray) GetTypeSupport() humble.MessageTypeSupport {
	return JoyFeedbackArrayTypeSupport
}

// JoyFeedbackArrayPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// JoyFeedbackArray
func NewJoyFeedbackArrayPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*JoyFeedbackArrayPublisher, error) {
...
// JoyFeedbackArraySubscription wraps humble.Subscription to provide type safe helper
// functions
...
type JoyFeedbackArraySubscriptionCallback func(msg *JoyFeedbackArray, info *humble.MessageInfo, err error)

// NewJoyFeedbackArraySubscription creates and returns a new subscription for the
// JoyFeedbackArray
func NewJoyFeedbackArraySubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback JoyFeedbackArraySubscriptionCallback) (*JoyFeedbackArraySubscription, error) {
...
func (s *JoyFeedbackArraySubscription) TakeMessage(out *JoyFeedbackArray) (*humble.MessageInfo, error) {
...
var JoyFeedbackArrayTypeSupport humble.MessageTypeSupport = _JoyFeedbackArrayTypeSupport{}

type _JoyFeedbackArrayTypeSupport struct{}

func (t _JoyFeedbackArrayTypeSupport) New() humble.Message {
...
func (t _JoyFeedbackArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*JoyFeedbackArray)
	mem := (*C.sensor_msgs__msg__JoyFeedbackArray)(dst)
	JoyFeedbackSequenceToC(&mem.array, m.Array)
}

func (t _JoyFeedbackArrayTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*JoyFeedbackArray)
