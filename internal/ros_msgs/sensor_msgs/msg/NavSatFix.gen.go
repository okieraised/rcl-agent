...
func init() {
	humble.RegisterMessage("sensor_msgs/NavSatFix", NavSatFixTypeSupport)
	humble.RegisterMessage("sensor_msgs/msg/NavSatFix", NavSatFixTypeSupport)
}
...
func (t *NavSatFix) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *NavSatFix) GetTypeSupport() humble.MessageTypeSupport {
	return NavSatFixTypeSupport
}

// NavSatFixPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// NavSatFix
func NewNavSatFixPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*NavSatFixPublisher, error) {
...
// NavSatFixSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type NavSatFixSubscriptionCallback func(msg *NavSatFix, info *humble.MessageInfo, err error)

// NewNavSatFixSubscription creates and returns a new subscription for the
// NavSatFix
func NewNavSatFixSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback NavSatFixSubscriptionCallback) (*NavSatFixSubscription, error) {
...
func (s *NavSatFixSubscription) TakeMessage(out *NavSatFix) (*humble.MessageInfo, error) {
...
var NavSatFixTypeSupport humble.MessageTypeSupport = _NavSatFixTypeSupport{}

type _NavSatFixTypeSupport struct{}

func (t _NavSatFixTypeSupport) New() humble.Message {
	return NewNavSatFix()
}
...
func (t _NavSatFixTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*NavSatFix)
	...
	humble.Float64ArrayToC(*(*[]humble.CFloat64)(unsafe.Pointer(&cSlice_position_covariance)), m.PositionCovariance[:])
	mem.position_covariance_type = C.uint8_t(m.PositionCovarianceType)
}

func (t _NavSatFixTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*NavSatFix)
	...
	cSlice_position_covariance := mem.position_covariance[:]
	humble.Float64ArrayToGo(m.PositionCovariance[:], *(*[]humble.CFloat64)(unsafe.Pointer(&cSlice_position_covariance)))
