...
func init() {
	humble.RegisterMessage("lifecycle_msgs/TransitionEvent", TransitionEventTypeSupport)
	humble.RegisterMessage("lifecycle_msgs/msg/TransitionEvent", TransitionEventTypeSupport)
}
...
func (t *TransitionEvent) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *TransitionEvent) GetTypeSupport() humble.MessageTypeSupport {
	return TransitionEventTypeSupport
}

// TransitionEventPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// TransitionEvent
func NewTransitionEventPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*TransitionEventPublisher, error) {
...
// TransitionEventSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type TransitionEventSubscriptionCallback func(msg *TransitionEvent, info *humble.MessageInfo, err error)

// NewTransitionEventSubscription creates and returns a new subscription for the
// TransitionEvent
func NewTransitionEventSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback TransitionEventSubscriptionCallback) (*TransitionEventSubscription, error) {
...
func (s *TransitionEventSubscription) TakeMessage(out *TransitionEvent) (*humble.MessageInfo, error) {
...
var TransitionEventTypeSupport humble.MessageTypeSupport = _TransitionEventTypeSupport{}

type _TransitionEventTypeSupport struct{}

func (t _TransitionEventTypeSupport) New() humble.Message {
...
func (t _TransitionEventTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _TransitionEventTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*TransitionEvent)
