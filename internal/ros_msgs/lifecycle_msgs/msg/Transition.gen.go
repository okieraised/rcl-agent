...
func init() {
	humble.RegisterMessage("lifecycle_msgs/Transition", TransitionTypeSupport)
	humble.RegisterMessage("lifecycle_msgs/msg/Transition", TransitionTypeSupport)
}
const (
...
func (t *Transition) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Transition) GetTypeSupport() humble.MessageTypeSupport {
	return TransitionTypeSupport
}

// TransitionPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// Transition
func NewTransitionPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*TransitionPublisher, error) {
...
// TransitionSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type TransitionSubscriptionCallback func(msg *Transition, info *humble.MessageInfo, err error)

// NewTransitionSubscription creates and returns a new subscription for the
// Transition
func NewTransitionSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback TransitionSubscriptionCallback) (*TransitionSubscription, error) {
...
func (s *TransitionSubscription) TakeMessage(out *Transition) (*humble.MessageInfo, error) {
...
var TransitionTypeSupport humble.MessageTypeSupport = _TransitionTypeSupport{}

type _TransitionTypeSupport struct{}

func (t _TransitionTypeSupport) New() humble.Message {
...
func (t _TransitionTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*Transition)
...
func (t _TransitionTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Transition)
