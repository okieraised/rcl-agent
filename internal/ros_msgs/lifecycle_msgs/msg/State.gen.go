...
func init() {
	humble.RegisterMessage("lifecycle_msgs/State", StateTypeSupport)
	humble.RegisterMessage("lifecycle_msgs/msg/State", StateTypeSupport)
}
const (
...
func (t *State) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *State) GetTypeSupport() humble.MessageTypeSupport {
	return StateTypeSupport
}

// StatePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// State
func NewStatePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*StatePublisher, error) {
...
// StateSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type StateSubscriptionCallback func(msg *State, info *humble.MessageInfo, err error)

// NewStateSubscription creates and returns a new subscription for the
// State
func NewStateSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback StateSubscriptionCallback) (*StateSubscription, error) {
...
func (s *StateSubscription) TakeMessage(out *State) (*humble.MessageInfo, error) {
...
var StateTypeSupport humble.MessageTypeSupport = _StateTypeSupport{}

type _StateTypeSupport struct{}

func (t _StateTypeSupport) New() humble.Message {
	return NewState()
}
...
func (t _StateTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*State)
...
func (t _StateTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*State)
