...
func init() {
	humble.RegisterMessage("composition_interfaces/LoadNode_Request", LoadNode_RequestTypeSupport)
	humble.RegisterMessage("composition_interfaces/srv/LoadNode_Request", LoadNode_RequestTypeSupport)
}
...
func (t *LoadNode_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *LoadNode_Request) GetTypeSupport() humble.MessageTypeSupport {
	return LoadNode_RequestTypeSupport
}

// LoadNode_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// LoadNode_Request
func NewLoadNode_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*LoadNode_RequestPublisher, error) {
...
// LoadNode_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type LoadNode_RequestSubscriptionCallback func(msg *LoadNode_Request, info *humble.MessageInfo, err error)

// NewLoadNode_RequestSubscription creates and returns a new subscription for the
// LoadNode_Request
func NewLoadNode_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback LoadNode_RequestSubscriptionCallback) (*LoadNode_RequestSubscription, error) {
...
func (s *LoadNode_RequestSubscription) TakeMessage(out *LoadNode_Request) (*humble.MessageInfo, error) {
...
var LoadNode_RequestTypeSupport humble.MessageTypeSupport = _LoadNode_RequestTypeSupport{}

type _LoadNode_RequestTypeSupport struct{}

func (t _LoadNode_RequestTypeSupport) New() humble.Message {
...
func (t _LoadNode_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*LoadNode_Request)
	mem := (*C.composition_interfaces__srv__LoadNode_Request)(dst)
	humble.StringAsCStruct(unsafe.Pointer(&mem.package_name), m.PackageName)
	humble.StringAsCStruct(unsafe.Pointer(&mem.plugin_name), m.PluginName)
	...
	humble.StringSequenceToC((*humble.CStringSequence)(unsafe.Pointer(&mem.remap_rules)), m.RemapRules)
...
func (t _LoadNode_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*LoadNode_Request)
	mem := (*C.composition_interfaces__srv__LoadNode_Request)(ros2_message_buffer)
	humble.StringAsGoStruct(&m.PackageName, unsafe.Pointer(&mem.package_name))
	humble.StringAsGoStruct(&m.PluginName, unsafe.Pointer(&mem.plugin_name))
	...
	humble.StringSequenceToGo(&m.RemapRules, *(*humble.CStringSequence)(unsafe.Pointer(&mem.remap_rules)))
