...
func init() {
	humble.RegisterMessage("geographic_msgs/GetGeoPath_Response", GetGeoPath_ResponseTypeSupport)
	humble.RegisterMessage("geographic_msgs/srv/GetGeoPath_Response", GetGeoPath_ResponseTypeSupport)
}
...
func (t *GetGeoPath_Response) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *GetGeoPath_Response) GetTypeSupport() humble.MessageTypeSupport {
	return GetGeoPath_ResponseTypeSupport
}

// GetGeoPath_ResponsePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// GetGeoPath_Response
func NewGetGeoPath_ResponsePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*GetGeoPath_ResponsePublisher, error) {
	pub, err := node.NewPublisher(topicName, GetGeoPath_ResponseTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// GetGeoPath_ResponseSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type GetGeoPath_ResponseSubscriptionCallback func(msg *GetGeoPath_Response, info *humble.MessageInfo, err error)

// NewGetGeoPath_ResponseSubscription creates and returns a new subscription for the
// GetGeoPath_Response
func NewGetGeoPath_ResponseSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback GetGeoPath_ResponseSubscriptionCallback) (*GetGeoPath_ResponseSubscription, error) {
	callback := func(s *humble.Subscription) {
		var msg GetGeoPath_Response
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, GetGeoPath_ResponseTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *GetGeoPath_ResponseSubscription) TakeMessage(out *GetGeoPath_Response) (*humble.MessageInfo, error) {
...
var GetGeoPath_ResponseTypeSupport humble.MessageTypeSupport = _GetGeoPath_ResponseTypeSupport{}

type _GetGeoPath_ResponseTypeSupport struct{}

func (t _GetGeoPath_ResponseTypeSupport) New() humble.Message {
...
func (t _GetGeoPath_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _GetGeoPath_ResponseTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*GetGeoPath_Response)
...
type CGetGeoPath_ResponseSequence = C.geographic_msgs__srv__GetGeoPath_Response__Sequence

func GetGeoPath_ResponseSequenceToGo(goSlice *[]GetGeoPath_Response, cSlice CGetGeoPath_ResponseSequence) {
	if cSlice.size == 0 {
		return
	}
...
func GetGeoPath_ResponseSequenceToC(cSlice *CGetGeoPath_ResponseSequence, goSlice []GetGeoPath_Response) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func GetGeoPath_ResponseArrayToGo(goSlice []GetGeoPath_Response, cSlice []CGetGeoPath_Response) {
	for i := 0; i < len(cSlice); i++ {
		GetGeoPath_ResponseTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func GetGeoPath_ResponseArrayToC(cSlice []CGetGeoPath_Response, goSlice []GetGeoPath_Response) {
