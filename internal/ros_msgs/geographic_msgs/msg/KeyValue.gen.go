...
func init() {
	humble.RegisterMessage("geographic_msgs/KeyValue", KeyValueTypeSupport)
	humble.RegisterMessage("geographic_msgs/msg/KeyValue", KeyValueTypeSupport)
}
...
type CKeyValueSequence = C.geographic_msgs__msg__KeyValue__Sequence
