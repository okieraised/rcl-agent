...
func init() {
	humble.RegisterMessage("geographic_msgs/GeoPoseWithCovarianceStamped", GeoPoseWithCovarianceStampedTypeSupport)
	humble.RegisterMessage("geographic_msgs/msg/GeoPoseWithCovarianceStamped", GeoPoseWithCovarianceStampedTypeSupport)
}
...
func (t *GeoPoseWithCovarianceStamped) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *GeoPoseWithCovarianceStamped) GetTypeSupport() humble.MessageTypeSupport {
	return GeoPoseWithCovarianceStampedTypeSupport
}

// GeoPoseWithCovarianceStampedPublisher wraps humble.Publisher to provide type safe helper
// functions
...
func NewGeoPoseWithCovarianceStampedPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*GeoPoseWithCovarianceStampedPublisher, error) {
	pub, err := node.NewPublisher(topicName, GeoPoseWithCovarianceStampedTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// GeoPoseWithCovarianceStampedSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type GeoPoseWithCovarianceStampedSubscriptionCallback func(msg *GeoPoseWithCovarianceStamped, info *humble.MessageInfo, err error)

// NewGeoPoseWithCovarianceStampedSubscription creates and returns a new subscription for the
// GeoPoseWithCovarianceStamped
func NewGeoPoseWithCovarianceStampedSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback GeoPoseWithCovarianceStampedSubscriptionCallback) (*GeoPoseWithCovarianceStampedSubscription, error) {
	callback := func(s *humble.Subscription) {
		var msg GeoPoseWithCovarianceStamped
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, GeoPoseWithCovarianceStampedTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *GeoPoseWithCovarianceStampedSubscription) TakeMessage(out *GeoPoseWithCovarianceStamped) (*humble.MessageInfo, error) {
...
var GeoPoseWithCovarianceStampedTypeSupport humble.MessageTypeSupport = _GeoPoseWithCovarianceStampedTypeSupport{}

type _GeoPoseWithCovarianceStampedTypeSupport struct{}

func (t _GeoPoseWithCovarianceStampedTypeSupport) New() humble.Message {
...
func (t _GeoPoseWithCovarianceStampedTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _GeoPoseWithCovarianceStampedTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*GeoPoseWithCovarianceStamped)
...
type CGeoPoseWithCovarianceStampedSequence = C.geographic_msgs__msg__GeoPoseWithCovarianceStamped__Sequence

func GeoPoseWithCovarianceStampedSequenceToGo(goSlice *[]GeoPoseWithCovarianceStamped, cSlice CGeoPoseWithCovarianceStampedSequence) {
	if cSlice.size == 0 {
		return
	}
...
func GeoPoseWithCovarianceStampedSequenceToC(cSlice *CGeoPoseWithCovarianceStampedSequence, goSlice []GeoPoseWithCovarianceStamped) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func GeoPoseWithCovarianceStampedArrayToGo(goSlice []GeoPoseWithCovarianceStamped, cSlice []CGeoPoseWithCovarianceStamped) {
	for i := 0; i < len(cSlice); i++ {
		GeoPoseWithCovarianceStampedTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func GeoPoseWithCovarianceStampedArrayToC(cSlice []CGeoPoseWithCovarianceStamped, goSlice []GeoPoseWithCovarianceStamped) {
