...
func init() {
	humble.RegisterMessage("geographic_msgs/GeoPoseWithCovariance", GeoPoseWithCovarianceTypeSupport)
	humble.RegisterMessage("geographic_msgs/msg/GeoPoseWithCovariance", GeoPoseWithCovarianceTypeSupport)
}
...
func (t *GeoPoseWithCovariance) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *GeoPoseWithCovariance) GetTypeSupport() humble.MessageTypeSupport {
	return GeoPoseWithCovarianceTypeSupport
}

// GeoPoseWithCovariancePublisher wraps humble.Publisher to provide type safe helper
// functions
...
func NewGeoPoseWithCovariancePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*GeoPoseWithCovariancePublisher, error) {
	pub, err := node.NewPublisher(topicName, GeoPoseWithCovarianceTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// GeoPoseWithCovarianceSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type GeoPoseWithCovarianceSubscriptionCallback func(msg *GeoPoseWithCovariance, info *humble.MessageInfo, err error)

// NewGeoPoseWithCovarianceSubscription creates and returns a new subscription for the
// GeoPoseWithCovariance
func NewGeoPoseWithCovarianceSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback GeoPoseWithCovarianceSubscriptionCallback) (*GeoPoseWithCovarianceSubscription, error) {
	callback := func(s *humble.Subscription) {
		var msg GeoPoseWithCovariance
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topicName, GeoPoseWithCovarianceTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *GeoPoseWithCovarianceSubscription) TakeMessage(out *GeoPoseWithCovariance) (*humble.MessageInfo, error) {
...
var GeoPoseWithCovarianceTypeSupport humble.MessageTypeSupport = _GeoPoseWithCovarianceTypeSupport{}

type _GeoPoseWithCovarianceTypeSupport struct{}

func (t _GeoPoseWithCovarianceTypeSupport) New() humble.Message {
...
func (t _GeoPoseWithCovarianceTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _GeoPoseWithCovarianceTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*GeoPoseWithCovariance)
...
type CGeoPoseWithCovarianceSequence = C.geographic_msgs__msg__GeoPoseWithCovariance__Sequence

func GeoPoseWithCovarianceSequenceToGo(goSlice *[]GeoPoseWithCovariance, cSlice CGeoPoseWithCovarianceSequence) {
	if cSlice.size == 0 {
		return
	}
...
func GeoPoseWithCovarianceSequenceToC(cSlice *CGeoPoseWithCovarianceSequence, goSlice []GeoPoseWithCovariance) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func GeoPoseWithCovarianceArrayToGo(goSlice []GeoPoseWithCovariance, cSlice []CGeoPoseWithCovariance) {
	for i := 0; i < len(cSlice); i++ {
		GeoPoseWithCovarianceTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}

func GeoPoseWithCovarianceArrayToC(cSlice []CGeoPoseWithCovariance, goSlice []GeoPoseWithCovariance) {
