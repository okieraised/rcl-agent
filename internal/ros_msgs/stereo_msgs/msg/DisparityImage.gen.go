...
func init() {
	humble.RegisterMessage("stereo_msgs/DisparityImage", DisparityImageTypeSupport)
	humble.RegisterMessage("stereo_msgs/msg/DisparityImage", DisparityImageTypeSupport)
}
...
func (t *DisparityImage) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *DisparityImage) GetTypeSupport() humble.MessageTypeSupport {
	return DisparityImageTypeSupport
}

// DisparityImagePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// DisparityImage
func NewDisparityImagePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*DisparityImagePublisher, error) {
...
// DisparityImageSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type DisparityImageSubscriptionCallback func(msg *DisparityImage, info *humble.MessageInfo, err error)

// NewDisparityImageSubscription creates and returns a new subscription for the
// DisparityImage
func NewDisparityImageSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback DisparityImageSubscriptionCallback) (*DisparityImageSubscription, error) {
...
func (s *DisparityImageSubscription) TakeMessage(out *DisparityImage) (*humble.MessageInfo, error) {
...
var DisparityImageTypeSupport humble.MessageTypeSupport = _DisparityImageTypeSupport{}

type _DisparityImageTypeSupport struct{}

func (t _DisparityImageTypeSupport) New() humble.Message {
...
func (t _DisparityImageTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _DisparityImageTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*DisparityImage)
