...
func init() {
	humble.RegisterMessage("actionlib_msgs/GoalStatusArray", GoalStatusArrayTypeSupport)
	humble.RegisterMessage("actionlib_msgs/msg/GoalStatusArray", GoalStatusArrayTypeSupport)
}
