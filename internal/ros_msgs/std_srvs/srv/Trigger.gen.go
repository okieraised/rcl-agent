...
func init() {
	humble.RegisterService("std_srvs/Trigger", TriggerTypeSupport)
...
func (s _TriggerTypeSupport) Response() humble.MessageTypeSupport {
...
var TriggerTypeSupport humble.ServiceTypeSupport = _TriggerTypeSupport{}

// TriggerClient wraps humble.Client to provide type safe helper
// functions
...
// Trigger
func NewTriggerClient(node *humble.Node, serviceName string, options *humble.ClientOptions) (*TriggerClient, error) {
...
func (s *TriggerClient) Send(ctx context.Context, req *Trigger_Request) (*Trigger_Response, *humble.ServiceInfo, error) {
...
type TriggerServiceRequestHandler func(*humble.ServiceInfo, *Trigger_Request, TriggerServiceResponseSender)

// TriggerService wraps humble.Service to provide type safe helper
// functions
