...
func init() {
	humble.RegisterMessage("std_srvs/Empty_Request", Empty_RequestTypeSupport)
	humble.RegisterMessage("std_srvs/srv/Empty_Request", Empty_RequestTypeSupport)
}
...
func (t *Empty_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Empty_Request) GetTypeSupport() humble.MessageTypeSupport {
	return Empty_RequestTypeSupport
}

// Empty_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// Empty_Request
func NewEmpty_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*Empty_RequestPublisher, error) {
...
// Empty_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type Empty_RequestSubscriptionCallback func(msg *Empty_Request, info *humble.MessageInfo, err error)

// NewEmpty_RequestSubscription creates and returns a new subscription for the
// Empty_Request
func NewEmpty_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback Empty_RequestSubscriptionCallback) (*Empty_RequestSubscription, error) {
...
func (s *Empty_RequestSubscription) TakeMessage(out *Empty_Request) (*humble.MessageInfo, error) {
...
var Empty_RequestTypeSupport humble.MessageTypeSupport = _Empty_RequestTypeSupport{}

type _Empty_RequestTypeSupport struct{}

func (t _Empty_RequestTypeSupport) New() humble.Message {
...
func (t _Empty_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	
}

func (t _Empty_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
