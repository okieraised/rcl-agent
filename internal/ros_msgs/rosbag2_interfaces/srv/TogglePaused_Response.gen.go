...
func init() {
	humble.RegisterMessage("rosbag2_interfaces/TogglePaused_Response", TogglePaused_ResponseTypeSupport)
	humble.RegisterMessage("rosbag2_interfaces/srv/TogglePaused_Response", TogglePaused_ResponseTypeSupport)
}
...
func (t *TogglePaused_Response) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *TogglePaused_Response) GetTypeSupport() humble.MessageTypeSupport {
	return TogglePaused_ResponseTypeSupport
}

// TogglePaused_ResponsePublisher wraps humble.Publisher to provide type safe helper
// functions
...
func NewTogglePaused_ResponsePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*TogglePaused_ResponsePublisher, error) {
...
// TogglePaused_ResponseSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type TogglePaused_ResponseSubscriptionCallback func(msg *TogglePaused_Response, info *humble.MessageInfo, err error)

// NewTogglePaused_ResponseSubscription creates and returns a new subscription for the
// TogglePaused_Response
func NewTogglePaused_ResponseSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback TogglePaused_ResponseSubscriptionCallback) (*TogglePaused_ResponseSubscription, error) {
...
func (s *TogglePaused_ResponseSubscription) TakeMessage(out *TogglePaused_Response) (*humble.MessageInfo, error) {
...
var TogglePaused_ResponseTypeSupport humble.MessageTypeSupport = _TogglePaused_ResponseTypeSupport{}

type _TogglePaused_ResponseTypeSupport struct{}

func (t _TogglePaused_ResponseTypeSupport) New() humble.Message {
...
func (t _TogglePaused_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	
}

func (t _TogglePaused_ResponseTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
