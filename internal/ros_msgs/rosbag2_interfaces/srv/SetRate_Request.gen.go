...
func init() {
	humble.RegisterMessage("rosbag2_interfaces/SetRate_Request", SetRate_RequestTypeSupport)
	humble.RegisterMessage("rosbag2_interfaces/srv/SetRate_Request", SetRate_RequestTypeSupport)
}
...
func (t *SetRate_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *SetRate_Request) GetTypeSupport() humble.MessageTypeSupport {
	return SetRate_RequestTypeSupport
}

// SetRate_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// SetRate_Request
func NewSetRate_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*SetRate_RequestPublisher, error) {
...
// SetRate_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type SetRate_RequestSubscriptionCallback func(msg *SetRate_Request, info *humble.MessageInfo, err error)

// NewSetRate_RequestSubscription creates and returns a new subscription for the
// SetRate_Request
func NewSetRate_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback SetRate_RequestSubscriptionCallback) (*SetRate_RequestSubscription, error) {
...
func (s *SetRate_RequestSubscription) TakeMessage(out *SetRate_Request) (*humble.MessageInfo, error) {
...
var SetRate_RequestTypeSupport humble.MessageTypeSupport = _SetRate_RequestTypeSupport{}

type _SetRate_RequestTypeSupport struct{}

func (t _SetRate_RequestTypeSupport) New() humble.Message {
...
func (t _SetRate_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*SetRate_Request)
	mem := (*C.rosbag2_interfaces__srv__SetRate_Request)(dst)
	mem.rate = C.double(m.Rate)
}

func (t _SetRate_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*SetRate_Request)
