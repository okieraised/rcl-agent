...
func init() {
	humble.RegisterMessage("rosbag2_interfaces/Snapshot_Request", Snapshot_RequestTypeSupport)
	humble.RegisterMessage("rosbag2_interfaces/srv/Snapshot_Request", Snapshot_RequestTypeSupport)
}
...
func (t *Snapshot_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Snapshot_Request) GetTypeSupport() humble.MessageTypeSupport {
	return Snapshot_RequestTypeSupport
}

// Snapshot_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// Snapshot_Request
func NewSnapshot_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*Snapshot_RequestPublisher, error) {
...
// Snapshot_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type Snapshot_RequestSubscriptionCallback func(msg *Snapshot_Request, info *humble.MessageInfo, err error)

// NewSnapshot_RequestSubscription creates and returns a new subscription for the
// Snapshot_Request
func NewSnapshot_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback Snapshot_RequestSubscriptionCallback) (*Snapshot_RequestSubscription, error) {
...
func (s *Snapshot_RequestSubscription) TakeMessage(out *Snapshot_Request) (*humble.MessageInfo, error) {
...
var Snapshot_RequestTypeSupport humble.MessageTypeSupport = _Snapshot_RequestTypeSupport{}

type _Snapshot_RequestTypeSupport struct{}

func (t _Snapshot_RequestTypeSupport) New() humble.Message {
...
func (t _Snapshot_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	
}

func (t _Snapshot_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
