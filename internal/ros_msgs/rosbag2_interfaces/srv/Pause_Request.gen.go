...
func init() {
	humble.RegisterMessage("rosbag2_interfaces/Pause_Request", Pause_RequestTypeSupport)
	humble.RegisterMessage("rosbag2_interfaces/srv/Pause_Request", Pause_RequestTypeSupport)
}
...
func (t *Pause_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Pause_Request) GetTypeSupport() humble.MessageTypeSupport {
	return Pause_RequestTypeSupport
}

// Pause_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// Pause_Request
func NewPause_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*Pause_RequestPublisher, error) {
...
// Pause_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type Pause_RequestSubscriptionCallback func(msg *Pause_Request, info *humble.MessageInfo, err error)

// NewPause_RequestSubscription creates and returns a new subscription for the
// Pause_Request
func NewPause_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback Pause_RequestSubscriptionCallback) (*Pause_RequestSubscription, error) {
...
func (s *Pause_RequestSubscription) TakeMessage(out *Pause_Request) (*humble.MessageInfo, error) {
...
var Pause_RequestTypeSupport humble.MessageTypeSupport = _Pause_RequestTypeSupport{}

type _Pause_RequestTypeSupport struct{}

func (t _Pause_RequestTypeSupport) New() humble.Message {
...
func (t _Pause_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {

}

func (t _Pause_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
