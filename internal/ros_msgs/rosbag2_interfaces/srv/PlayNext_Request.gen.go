...
func init() {
	humble.RegisterMessage("rosbag2_interfaces/PlayNext_Request", PlayNext_RequestTypeSupport)
	humble.RegisterMessage("rosbag2_interfaces/srv/PlayNext_Request", PlayNext_RequestTypeSupport)
}
...
func (t *PlayNext_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *PlayNext_Request) GetTypeSupport() humble.MessageTypeSupport {
	return PlayNext_RequestTypeSupport
}

// PlayNext_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// PlayNext_Request
func NewPlayNext_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*PlayNext_RequestPublisher, error) {
...
// PlayNext_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type PlayNext_RequestSubscriptionCallback func(msg *PlayNext_Request, info *humble.MessageInfo, err error)

// NewPlayNext_RequestSubscription creates and returns a new subscription for the
// PlayNext_Request
func NewPlayNext_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback PlayNext_RequestSubscriptionCallback) (*PlayNext_RequestSubscription, error) {
...
func (s *PlayNext_RequestSubscription) TakeMessage(out *PlayNext_Request) (*humble.MessageInfo, error) {
...
var PlayNext_RequestTypeSupport humble.MessageTypeSupport = _PlayNext_RequestTypeSupport{}

type _PlayNext_RequestTypeSupport struct{}

func (t _PlayNext_RequestTypeSupport) New() humble.Message {
...
func (t _PlayNext_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {

}

func (t _PlayNext_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
