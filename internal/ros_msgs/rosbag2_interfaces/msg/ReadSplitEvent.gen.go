...
func init() {
	humble.RegisterMessage("rosbag2_interfaces/ReadSplitEvent", ReadSplitEventTypeSupport)
	humble.RegisterMessage("rosbag2_interfaces/msg/ReadSplitEvent", ReadSplitEventTypeSupport)
}
...
func (t *ReadSplitEvent) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *ReadSplitEvent) GetTypeSupport() humble.MessageTypeSupport {
	return ReadSplitEventTypeSupport
}

// ReadSplitEventPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// ReadSplitEvent
func NewReadSplitEventPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*ReadSplitEventPublisher, error) {
...
// ReadSplitEventSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type ReadSplitEventSubscriptionCallback func(msg *ReadSplitEvent, info *humble.MessageInfo, err error)

// NewReadSplitEventSubscription creates and returns a new subscription for the
// ReadSplitEvent
func NewReadSplitEventSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback ReadSplitEventSubscriptionCallback) (*ReadSplitEventSubscription, error) {
...
func (s *ReadSplitEventSubscription) TakeMessage(out *ReadSplitEvent) (*humble.MessageInfo, error) {
...
var ReadSplitEventTypeSupport humble.MessageTypeSupport = _ReadSplitEventTypeSupport{}

type _ReadSplitEventTypeSupport struct{}

func (t _ReadSplitEventTypeSupport) New() humble.Message {
...
func (t _ReadSplitEventTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _ReadSplitEventTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*ReadSplitEvent)
