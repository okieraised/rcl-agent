...
func init() {
	humble.RegisterMessage("action_msgs/CancelGoal_Request", CancelGoal_RequestTypeSupport)
	humble.RegisterMessage("action_msgs/srv/CancelGoal_Request", CancelGoal_RequestTypeSupport)
}
...
func (t *CancelGoal_Request) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *CancelGoal_Request) GetTypeSupport() humble.MessageTypeSupport {
	return CancelGoal_RequestTypeSupport
}
func (t *CancelGoal_Request) GetGoalID() *humble.GoalID {
	return (*humble.GoalID)(&t.GoalInfo.GoalId.Uuid)
}

func (t *CancelGoal_Request) SetGoalID(id *humble.GoalID) {
	t.GoalInfo.GoalId.Uuid = *id
}

// CancelGoal_RequestPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// CancelGoal_Request
func NewCancelGoal_RequestPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*CancelGoal_RequestPublisher, error) {
...
// CancelGoal_RequestSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type CancelGoal_RequestSubscriptionCallback func(msg *CancelGoal_Request, info *humble.MessageInfo, err error)

// NewCancelGoal_RequestSubscription creates and returns a new subscription for the
// CancelGoal_Request
func NewCancelGoal_RequestSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback CancelGoal_RequestSubscriptionCallback) (*CancelGoal_RequestSubscription, error) {
...
func (s *CancelGoal_RequestSubscription) TakeMessage(out *CancelGoal_Request) (*humble.MessageInfo, error) {
...
var CancelGoal_RequestTypeSupport humble.MessageTypeSupport = _CancelGoal_RequestTypeSupport{}

type _CancelGoal_RequestTypeSupport struct{}

func (t _CancelGoal_RequestTypeSupport) New() humble.Message {
...
func (t _CancelGoal_RequestTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _CancelGoal_RequestTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*CancelGoal_Request)
