...
func init() {
	humble.RegisterService("action_msgs/CancelGoal", CancelGoalTypeSupport)
...
func (s _CancelGoalTypeSupport) Response() humble.MessageTypeSupport {
...
var CancelGoalTypeSupport humble.ServiceTypeSupport = _CancelGoalTypeSupport{}

// CancelGoalClient wraps humble.Client to provide type safe helper
// functions
...
// CancelGoal
func NewCancelGoalClient(node *humble.Node, serviceName string, options *humble.ClientOptions) (*CancelGoalClient, error) {
...
func (s *CancelGoalClient) Send(ctx context.Context, req *CancelGoal_Request) (*CancelGoal_Response, *humble.ServiceInfo, error) {
...
type CancelGoalServiceRequestHandler func(*humble.ServiceInfo, *CancelGoal_Request, CancelGoalServiceResponseSender)

// CancelGoalService wraps humble.Service to provide type safe helper
// functions
