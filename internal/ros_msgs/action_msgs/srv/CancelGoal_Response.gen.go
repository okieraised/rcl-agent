...
func init() {
	humble.RegisterMessage("action_msgs/CancelGoal_Response", CancelGoal_ResponseTypeSupport)
	humble.RegisterMessage("action_msgs/srv/CancelGoal_Response", CancelGoal_ResponseTypeSupport)
}
const (
...
func (t *CancelGoal_Response) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *CancelGoal_Response) GetTypeSupport() humble.MessageTypeSupport {
	return CancelGoal_ResponseTypeSupport
}
func (t *CancelGoal_Response) CallForEach(f func(interface{})) {
	for i := range t.GoalsCanceling {
		f((*humble.GoalID)(&t.GoalsCanceling[i].GoalId.Uuid))
	}
}

// CancelGoal_ResponsePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// CancelGoal_Response
func NewCancelGoal_ResponsePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*CancelGoal_ResponsePublisher, error) {
...
// CancelGoal_ResponseSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type CancelGoal_ResponseSubscriptionCallback func(msg *CancelGoal_Response, info *humble.MessageInfo, err error)

// NewCancelGoal_ResponseSubscription creates and returns a new subscription for the
// CancelGoal_Response
func NewCancelGoal_ResponseSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback CancelGoal_ResponseSubscriptionCallback) (*CancelGoal_ResponseSubscription, error) {
...
func (s *CancelGoal_ResponseSubscription) TakeMessage(out *CancelGoal_Response) (*humble.MessageInfo, error) {
...
var CancelGoal_ResponseTypeSupport humble.MessageTypeSupport = _CancelGoal_ResponseTypeSupport{}

type _CancelGoal_ResponseTypeSupport struct{}

func (t _CancelGoal_ResponseTypeSupport) New() humble.Message {
...
func (t _CancelGoal_ResponseTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _CancelGoal_ResponseTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*CancelGoal_Response)
