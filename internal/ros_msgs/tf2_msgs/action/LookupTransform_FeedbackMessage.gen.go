...
func init() {
	humble.RegisterMessage("tf2_msgs/LookupTransform_FeedbackMessage", LookupTransform_FeedbackMessageTypeSupport)
	humble.RegisterMessage("tf2_msgs/action/LookupTransform_FeedbackMessage", LookupTransform_FeedbackMessageTypeSupport)
}
...
func (t *LookupTransform_FeedbackMessage) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *LookupTransform_FeedbackMessage) GetTypeSupport() humble.MessageTypeSupport {
	return LookupTransform_FeedbackMessageTypeSupport
}
func (t *LookupTransform_FeedbackMessage) GetGoalID() *humble.GoalID {
	return (*humble.GoalID)(&t.GoalID.Uuid)
}

func (t *LookupTransform_FeedbackMessage) SetGoalID(id *humble.GoalID) {
	t.GoalID.Uuid = *id
}

// LookupTransform_FeedbackMessagePublisher wraps humble.Publisher to provide type safe helper
// functions
...
func NewLookupTransform_FeedbackMessagePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*LookupTransform_FeedbackMessagePublisher, error) {
...
// LookupTransform_FeedbackMessageSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type LookupTransform_FeedbackMessageSubscriptionCallback func(msg *LookupTransform_FeedbackMessage, info *humble.MessageInfo, err error)

// NewLookupTransform_FeedbackMessageSubscription creates and returns a new subscription for the
// LookupTransform_FeedbackMessage
func NewLookupTransform_FeedbackMessageSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback LookupTransform_FeedbackMessageSubscriptionCallback) (*LookupTransform_FeedbackMessageSubscription, error) {
...
func (s *LookupTransform_FeedbackMessageSubscription) TakeMessage(out *LookupTransform_FeedbackMessage) (*humble.MessageInfo, error) {
...
var LookupTransform_FeedbackMessageTypeSupport humble.MessageTypeSupport = _LookupTransform_FeedbackMessageTypeSupport{}

type _LookupTransform_FeedbackMessageTypeSupport struct{}

func (t _LookupTransform_FeedbackMessageTypeSupport) New() humble.Message {
...
func (t _LookupTransform_FeedbackMessageTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _LookupTransform_FeedbackMessageTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*LookupTransform_FeedbackMessage)
