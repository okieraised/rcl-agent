...
func init() {
	humble.RegisterMessage("geometry_msgs/PointStamped", PointStampedTypeSupport)
	humble.RegisterMessage("geometry_msgs/msg/PointStamped", PointStampedTypeSupport)
}
...
func (t *PointStamped) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *PointStamped) GetTypeSupport() humble.MessageTypeSupport {
	return PointStampedTypeSupport
}

// PointStampedPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// PointStamped
func NewPointStampedPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*PointStampedPublisher, error) {
...
// PointStampedSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type PointStampedSubscriptionCallback func(msg *PointStamped, info *humble.MessageInfo, err error)

// NewPointStampedSubscription creates and returns a new subscription for the
// PointStamped
func NewPointStampedSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback PointStampedSubscriptionCallback) (*PointStampedSubscription, error) {
...
func (s *PointStampedSubscription) TakeMessage(out *PointStamped) (*humble.MessageInfo, error) {
...
var PointStampedTypeSupport humble.MessageTypeSupport = _PointStampedTypeSupport{}

type _PointStampedTypeSupport struct{}

func (t _PointStampedTypeSupport) New() humble.Message {
...
func (t _PointStampedTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*PointStamped)
...
func (t _PointStampedTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*PointStamped)
