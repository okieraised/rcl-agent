...
func init() {
	humble.RegisterMessage("geometry_msgs/PolygonStamped", PolygonStampedTypeSupport)
	humble.RegisterMessage("geometry_msgs/msg/PolygonStamped", PolygonStampedTypeSupport)
}
...
func (t *PolygonStamped) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *PolygonStamped) GetTypeSupport() humble.MessageTypeSupport {
	return PolygonStampedTypeSupport
}

// PolygonStampedPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// PolygonStamped
func NewPolygonStampedPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*PolygonStampedPublisher, error) {
...
// PolygonStampedSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type PolygonStampedSubscriptionCallback func(msg *PolygonStamped, info *humble.MessageInfo, err error)

// NewPolygonStampedSubscription creates and returns a new subscription for the
// PolygonStamped
func NewPolygonStampedSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback PolygonStampedSubscriptionCallback) (*PolygonStampedSubscription, error) {
...
func (s *PolygonStampedSubscription) TakeMessage(out *PolygonStamped) (*humble.MessageInfo, error) {
...
var PolygonStampedTypeSupport humble.MessageTypeSupport = _PolygonStampedTypeSupport{}

type _PolygonStampedTypeSupport struct{}

func (t _PolygonStampedTypeSupport) New() humble.Message {
...
func (t _PolygonStampedTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _PolygonStampedTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*PolygonStamped)
