...
func init() {
	humble.RegisterMessage("geometry_msgs/Pose2D", Pose2DTypeSupport)
	humble.RegisterMessage("geometry_msgs/msg/Pose2D", Pose2DTypeSupport)
}
...
func (t *Pose2D) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Pose2D) GetTypeSupport() humble.MessageTypeSupport {
	return Pose2DTypeSupport
}

// Pose2DPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// Pose2D
func NewPose2DPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*Pose2DPublisher, error) {
...
// Pose2DSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type Pose2DSubscriptionCallback func(msg *Pose2D, info *humble.MessageInfo, err error)

// NewPose2DSubscription creates and returns a new subscription for the
// Pose2D
func NewPose2DSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback Pose2DSubscriptionCallback) (*Pose2DSubscription, error) {
...
func (s *Pose2DSubscription) TakeMessage(out *Pose2D) (*humble.MessageInfo, error) {
...
var Pose2DTypeSupport humble.MessageTypeSupport = _Pose2DTypeSupport{}

type _Pose2DTypeSupport struct{}

func (t _Pose2DTypeSupport) New() humble.Message {
	return NewPose2D()
}
...
func (t _Pose2DTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*Pose2D)
...
func (t _Pose2DTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Pose2D)
