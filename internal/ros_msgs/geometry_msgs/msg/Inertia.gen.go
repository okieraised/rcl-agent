...
func init() {
	humble.RegisterMessage("geometry_msgs/Inertia", InertiaTypeSupport)
	humble.RegisterMessage("geometry_msgs/msg/Inertia", InertiaTypeSupport)
}
...
func (t *Inertia) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Inertia) GetTypeSupport() humble.MessageTypeSupport {
	return InertiaTypeSupport
}

// InertiaPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// Inertia
func NewInertiaPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*InertiaPublisher, error) {
...
// InertiaSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type InertiaSubscriptionCallback func(msg *Inertia, info *humble.MessageInfo, err error)

// NewInertiaSubscription creates and returns a new subscription for the
// Inertia
func NewInertiaSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback InertiaSubscriptionCallback) (*InertiaSubscription, error) {
...
func (s *InertiaSubscription) TakeMessage(out *Inertia) (*humble.MessageInfo, error) {
...
var InertiaTypeSupport humble.MessageTypeSupport = _InertiaTypeSupport{}

type _InertiaTypeSupport struct{}

func (t _InertiaTypeSupport) New() humble.Message {
	return NewInertia()
}
...
func (t _InertiaTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*Inertia)
...
func (t _InertiaTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Inertia)
