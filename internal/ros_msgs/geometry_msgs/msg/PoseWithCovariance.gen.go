...
func init() {
	humble.RegisterMessage("geometry_msgs/PoseWithCovariance", PoseWithCovarianceTypeSupport)
	humble.RegisterMessage("geometry_msgs/msg/PoseWithCovariance", PoseWithCovarianceTypeSupport)
}
...
func (t *PoseWithCovariance) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *PoseWithCovariance) GetTypeSupport() humble.MessageTypeSupport {
	return PoseWithCovarianceTypeSupport
}

// PoseWithCovariancePublisher wraps humble.Publisher to provide type safe helper
// functions
...
// PoseWithCovariance
func NewPoseWithCovariancePublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*PoseWithCovariancePublisher, error) {
...
// PoseWithCovarianceSubscription wraps humble.Subscription to provide type safe helper
// functions
...
type PoseWithCovarianceSubscriptionCallback func(msg *PoseWithCovariance, info *humble.MessageInfo, err error)

// NewPoseWithCovarianceSubscription creates and returns a new subscription for the
// PoseWithCovariance
func NewPoseWithCovarianceSubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback PoseWithCovarianceSubscriptionCallback) (*PoseWithCovarianceSubscription, error) {
...
func (s *PoseWithCovarianceSubscription) TakeMessage(out *PoseWithCovariance) (*humble.MessageInfo, error) {
...
var PoseWithCovarianceTypeSupport humble.MessageTypeSupport = _PoseWithCovarianceTypeSupport{}

type _PoseWithCovarianceTypeSupport struct{}

func (t _PoseWithCovarianceTypeSupport) New() humble.Message {
...
func (t _PoseWithCovarianceTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _PoseWithCovarianceTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*PoseWithCovariance)
