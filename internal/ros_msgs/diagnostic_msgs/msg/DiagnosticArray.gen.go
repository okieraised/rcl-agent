...
func init() {
	humble.RegisterMessage("diagnostic_msgs/DiagnosticArray", DiagnosticArrayTypeSupport)
	humble.RegisterMessage("diagnostic_msgs/msg/DiagnosticArray", DiagnosticArrayTypeSupport)
}
...
func (t *DiagnosticArray) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *DiagnosticArray) GetTypeSupport() humble.MessageTypeSupport {
	return DiagnosticArrayTypeSupport
}

// DiagnosticArrayPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// DiagnosticArray
func NewDiagnosticArrayPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*DiagnosticArrayPublisher, error) {
...
// DiagnosticArraySubscription wraps humble.Subscription to provide type safe helper
// functions
...
type DiagnosticArraySubscriptionCallback func(msg *DiagnosticArray, info *humble.MessageInfo, err error)

// NewDiagnosticArraySubscription creates and returns a new subscription for the
// DiagnosticArray
func NewDiagnosticArraySubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback DiagnosticArraySubscriptionCallback) (*DiagnosticArraySubscription, error) {
...
func (s *DiagnosticArraySubscription) TakeMessage(out *DiagnosticArray) (*humble.MessageInfo, error) {
...
var DiagnosticArrayTypeSupport humble.MessageTypeSupport = _DiagnosticArrayTypeSupport{}

type _DiagnosticArrayTypeSupport struct{}

func (t _DiagnosticArrayTypeSupport) New() humble.Message {
...
func (t _DiagnosticArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _DiagnosticArrayTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*DiagnosticArray)
