...
func init() {
	humble.RegisterService("diagnostic_msgs/SelfTest", SelfTestTypeSupport)
...
func (s _SelfTestTypeSupport) Response() humble.MessageTypeSupport {
...
var SelfTestTypeSupport humble.ServiceTypeSupport = _SelfTestTypeSupport{}

// SelfTestClient wraps humble.Client to provide type safe helper
// functions
...
// SelfTest
func NewSelfTestClient(node *humble.Node, serviceName string, options *humble.ClientOptions) (*SelfTestClient, error) {
...
func (s *SelfTestClient) Send(ctx context.Context, req *SelfTest_Request) (*SelfTest_Response, *humble.ServiceInfo, error) {
...
type SelfTestServiceRequestHandler func(*humble.ServiceInfo, *SelfTest_Request, SelfTestServiceResponseSender)

// SelfTestService wraps humble.Service to provide type safe helper
// functions
