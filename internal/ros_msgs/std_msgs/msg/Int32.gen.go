...
func init() {
	humble.RegisterMessage("std_msgs/Int32", Int32TypeSupport)
	humble.RegisterMessage("std_msgs/msg/Int32", Int32TypeSupport)
}
...
func (t *Int32) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Int32) GetTypeSupport() humble.MessageTypeSupport {
	return Int32TypeSupport
}

// Int32Publisher wraps humble.Publisher to provide type safe helper
// functions
...
// Int32
func NewInt32Publisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*Int32Publisher, error) {
...
// Int32Subscription wraps humble.Subscription to provide type safe helper
// functions
...
type Int32SubscriptionCallback func(msg *Int32, info *humble.MessageInfo, err error)

// NewInt32Subscription creates and returns a new subscription for the
// Int32
func NewInt32Subscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback Int32SubscriptionCallback) (*Int32Subscription, error) {
...
func (s *Int32Subscription) TakeMessage(out *Int32) (*humble.MessageInfo, error) {
...
var Int32TypeSupport humble.MessageTypeSupport = _Int32TypeSupport{}

type _Int32TypeSupport struct{}

func (t _Int32TypeSupport) New() humble.Message {
	return NewInt32()
}
...
func (t _Int32TypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*Int32)
	mem := (*C.std_msgs__msg__Int32)(dst)
	mem.data = C.int32_t(m.Data)
}

func (t _Int32TypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Int32)
