...
func init() {
	humble.RegisterMessage("std_msgs/UInt8MultiArray", UInt8MultiArrayTypeSupport)
	humble.RegisterMessage("std_msgs/msg/UInt8MultiArray", UInt8MultiArrayTypeSupport)
}
...
func (t *UInt8MultiArray) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *UInt8MultiArray) GetTypeSupport() humble.MessageTypeSupport {
	return UInt8MultiArrayTypeSupport
}

// UInt8MultiArrayPublisher wraps humble.Publisher to provide type safe helper
// functions
...
// UInt8MultiArray
func NewUInt8MultiArrayPublisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*UInt8MultiArrayPublisher, error) {
...
// UInt8MultiArraySubscription wraps humble.Subscription to provide type safe helper
// functions
...
type UInt8MultiArraySubscriptionCallback func(msg *UInt8MultiArray, info *humble.MessageInfo, err error)

// NewUInt8MultiArraySubscription creates and returns a new subscription for the
// UInt8MultiArray
func NewUInt8MultiArraySubscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback UInt8MultiArraySubscriptionCallback) (*UInt8MultiArraySubscription, error) {
...
func (s *UInt8MultiArraySubscription) TakeMessage(out *UInt8MultiArray) (*humble.MessageInfo, error) {
...
var UInt8MultiArrayTypeSupport humble.MessageTypeSupport = _UInt8MultiArrayTypeSupport{}

type _UInt8MultiArrayTypeSupport struct{}

func (t _UInt8MultiArrayTypeSupport) New() humble.Message {
...
func (t _UInt8MultiArrayTypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
...
func (t _UInt8MultiArrayTypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*UInt8MultiArray)
