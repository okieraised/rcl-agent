...
func init() {
	humble.RegisterMessage("std_msgs/Int16", Int16TypeSupport)
	humble.RegisterMessage("std_msgs/msg/Int16", Int16TypeSupport)
}
...
func (t *Int16) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *Int16) GetTypeSupport() humble.MessageTypeSupport {
	return Int16TypeSupport
}

// Int16Publisher wraps humble.Publisher to provide type safe helper
// functions
...
// Int16
func NewInt16Publisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*Int16Publisher, error) {
...
// Int16Subscription wraps humble.Subscription to provide type safe helper
// functions
...
type Int16SubscriptionCallback func(msg *Int16, info *humble.MessageInfo, err error)

// NewInt16Subscription creates and returns a new subscription for the
// Int16
func NewInt16Subscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback Int16SubscriptionCallback) (*Int16Subscription, error) {
...
func (s *Int16Subscription) TakeMessage(out *Int16) (*humble.MessageInfo, error) {
...
var Int16TypeSupport humble.MessageTypeSupport = _Int16TypeSupport{}

type _Int16TypeSupport struct{}

func (t _Int16TypeSupport) New() humble.Message {
	return NewInt16()
}
...
func (t _Int16TypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*Int16)
	mem := (*C.std_msgs__msg__Int16)(dst)
	mem.data = C.int16_t(m.Data)
}

func (t _Int16TypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*Int16)
