...
func init() {
	humble.RegisterMessage("std_msgs/UInt8", UInt8TypeSupport)
	humble.RegisterMessage("std_msgs/msg/UInt8", UInt8TypeSupport)
}
...
func (t *UInt8) CloneMsg() humble.Message {
	return t.Clone()
}
...
func (t *UInt8) GetTypeSupport() humble.MessageTypeSupport {
	return UInt8TypeSupport
}

// UInt8Publisher wraps humble.Publisher to provide type safe helper
// functions
...
// UInt8
func NewUInt8Publisher(node *humble.Node, topicName string, options *humble.PublisherOptions) (*UInt8Publisher, error) {
...
// UInt8Subscription wraps humble.Subscription to provide type safe helper
// functions
...
type UInt8SubscriptionCallback func(msg *UInt8, info *humble.MessageInfo, err error)

// NewUInt8Subscription creates and returns a new subscription for the
// UInt8
func NewUInt8Subscription(node *humble.Node, topicName string, opts *humble.SubscriptionOptions, subscriptionCallback UInt8SubscriptionCallback) (*UInt8Subscription, error) {
...
func (s *UInt8Subscription) TakeMessage(out *UInt8) (*humble.MessageInfo, error) {
...
var UInt8TypeSupport humble.MessageTypeSupport = _UInt8TypeSupport{}

type _UInt8TypeSupport struct{}

func (t _UInt8TypeSupport) New() humble.Message {
	return NewUInt8()
}
...
func (t _UInt8TypeSupport) AsCStruct(dst unsafe.Pointer, msg humble.Message) {
	m := msg.(*UInt8)
	mem := (*C.std_msgs__msg__UInt8)(dst)
	mem.data = C.uint8_t(m.Data)
}

func (t _UInt8TypeSupport) AsGoStruct(msg humble.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*UInt8)
